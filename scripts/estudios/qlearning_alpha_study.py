#!/usr/bin/env python3
"""
Q-Learning: Comparación de Alpha (Learning Rate)
10K episodios
"""
...
def main():
    print("\n" + "="*70)
    print("  Q-LEARNING: Comparación de Alpha (Learning Rate)")
    ...
    for alpha in alphas:
        ...
        agent = QLearningAgent(48, 4, alpha=alpha, gamma=0.99, epsilon=0.1)
    ...
    plt.suptitle('Q-Learning: Efecto del Alpha (Learning Rate)', fontsize=14, fontweight='bold')
    plt.tight_layout()
    plt.savefig('graphs/qlearning/qlearning_alpha_comparison.png', dpi=150)
    plt.close()
    
    print(f"\n  Guardado: graphs/qlearning/qlearning_alpha_comparison.png")
    print("="*70 + "\n")
