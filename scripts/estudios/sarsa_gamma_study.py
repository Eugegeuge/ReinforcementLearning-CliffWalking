#!/usr/bin/env python3
"""
SARSA: Comparación de Gamma (Factor de Descuento)
10K episodios
"""
...
def main():
    print("\n" + "="*70)
    print("  SARSA: Comparación de Gamma (Factor de Descuento)")
    ...
    for gamma in gammas:
        ...
        agent = SarsaAgent(48, 4, alpha=0.1, gamma=gamma, epsilon=0.1)
    ...
    plt.suptitle('SARSA: Efecto del Gamma (Factor de Descuento)', fontsize=14, fontweight='bold')
    plt.tight_layout()
    plt.savefig('graphs/sarsa/sarsa_gamma_comparison.png', dpi=150)
    plt.close()
    
    print(f"\n  Guardado: graphs/sarsa/sarsa_gamma_comparison.png")
    print("="*70 + "\n")
