#!/usr/bin/env python3
"""
Monte Carlo: Comparación de Gamma (Factor de Descuento)
10K episodios
"""
...
def main():
    print("\n" + "="*70)
    print("  MONTE CARLO: Comparación de Gamma (Factor de Descuento)")
    ...
    for gamma in gammas:
        ...
        agent = MonteCarloAgent(48, 4, alpha=0.1, gamma=gamma, epsilon=0.1)
    ...
    plt.suptitle('Monte Carlo: Efecto del Gamma (Factor de Descuento)', fontsize=14, fontweight='bold')
    plt.tight_layout()
    plt.savefig('montecarlo_gamma_comparison.png', dpi=150)
    plt.close()
    
    print(f"\n  Guardado: montecarlo_gamma_comparison.png")
    print("="*70 + "\n")
