...
def main():
    print("\n" + "="*70)
    print("  SARSA: Comparación de Epsilon")
    ...
    for eps in epsilons:
        ...
        agent = SarsaAgent(48, 4, alpha=0.1, gamma=0.99, epsilon=eps)
    ...
    plt.suptitle('SARSA: Efecto del Epsilon', fontsize=14, fontweight='bold')
    plt.tight_layout()
    plt.savefig('graphs/sarsa/sarsa_epsilon_comparison.png', dpi=150)
    plt.close()
    
    print(f"\n  Guardado: graphs/sarsa/sarsa_epsilon_comparison.png")
    print("="*70 + "\n")
