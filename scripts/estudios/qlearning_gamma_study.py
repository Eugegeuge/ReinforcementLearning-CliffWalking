#!/usr/bin/env python3
"""
Q-Learning: Comparación de Gamma (Factor de Descuento)
10K episodios
"""
...
def main():
    print("\n" + "="*70)
    print("  Q-LEARNING: Comparación de Gamma (Factor de Descuento)")
    print("  10K episodios | α=0.1, ε=0.1")
    print("="*70)
    ...
    for gamma in gammas:
        ...
        agent = QLearningAgent(48, 4, alpha=0.1, gamma=gamma, epsilon=0.1)
    ...
    print("  RESULTADOS")
    print("="*70)
    print(f"\n{'Gamma':<10} | {'Avg Total':>10} | {'Avg últ.100':>12} | {'Avg últ.1000':>12} | {'Éxito':>8}")
    print("-"*70)
    ...
    ax3.set_title('Comparación Final por Gamma', fontsize=12)
    ax3.set_xticks(x)
    ...
    plt.suptitle('Q-Learning: Efecto del Gamma (Factor de Descuento)', fontsize=14, fontweight='bold')
    plt.tight_layout()
    plt.savefig('graphs/qlearning/qlearning_gamma_comparison.png', dpi=150)
    plt.close()
    
    print(f"\n  Guardado: graphs/qlearning/qlearning_gamma_comparison.png")
    print("="*70 + "\n")
