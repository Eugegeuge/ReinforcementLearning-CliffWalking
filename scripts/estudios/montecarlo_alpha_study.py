#!/usr/bin/env python3
"""
Monte Carlo: Comparación de Alpha (Learning Rate)
10K episodios
"""
...
def main():
    print("\n" + "="*70)
    print("  MONTE CARLO: Comparación de Alpha (Learning Rate)")
    print("  10K episodios | ε=0.1 fijo")
    print("="*70)
    ...
    for alpha in alphas:
        ...
        agent = MonteCarloAgent(48, 4, alpha=alpha, epsilon=0.1)
    ...
    plt.suptitle('Monte Carlo: Efecto del Alpha (Learning Rate)', fontsize=14, fontweight='bold')
    plt.tight_layout()
    plt.savefig('montecarlo_alpha_comparison.png', dpi=150)
    plt.close()
    
    print(f"\n  Guardado: montecarlo_alpha_comparison.png")
    print("="*70 + "\n")
